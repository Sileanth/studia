...
Theorem mul_m_S_n : forall m n : nat, n * (m + 1) = n * m + n.
Proof.
  intros m n.
  induction n.
  + simpl. reflexivity.
...
Fixpoint normalize (b:bin) : bin :=
  match b with 
  | Z => Z
  | B0 bb => double_bin (normalize bb)
  | B1 bb => incr (double_bin (normalize bb))
  end.
...
Lemma double_bin_nat_to_bin : forall n : nat,
