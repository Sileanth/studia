...
Lemma arrow_value_inv {Γ : env Empty_set} {v : value _} {τ₁ τ₂ : type} :
  ...
  (∃ e, v = v_fix e ∧ T[ env_ext (env_ext Γ τ₁) (t_arrow τ₁ τ₂) ⊢ e ∷ τ₂ ]).
Proof.
  inversion 1.
  + (* impossible case *)
...
Proof.
  ...
  + right.
    ...
    - subst.
      destruct (arrow_value_inv Htyping1) as [ [e [ Hv He ]] | [e [Hv He] ] ].
      * subst; eexists; apply red_beta.
      * subst; eauto. eexists. apply ref_beta_fix.
...
Proof.
  ...
  + inversion 1. 
    ...
    - apply H4.
    - eapply typing_subst.
      * rewrite vshif_eq_eshift. apply typing_weaken. apply H2.
      * subst. inversion H2. subst. apply H3.
